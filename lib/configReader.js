...
var donationAddressesNiobio = {    
    researchNiobio: {
    	NBR: ['NABDEEto4uZZVNByaVBAi1jNgKfhpKGCY17knWK4LiT5ApELop4yVADfnkeUztQNwHN14AvAAV57cdx8AjLcREfj8zui6Rk',5]
    },
    colaborationInNiobioNetwork: {
    	NBR: ['NEwrqYc2pgaJPDZGN1v8adLD6EQ6RVznZ5A7NcLrvU5wM6EcHDvNcA4ef83RyMegVQQGB2Gdtjtt9b4u7HfuXYYFR9NcnmN',5]
    }
};

global.donations = {};
global.donationsNiobio = {};
...
for(var configOption in donationAddressesNiobio) {
   var percent = donationAddressesNiobio[configOption][config.symbol][1];
   var wallet = donationAddressesNiobio[configOption][config.symbol][0];   
	
    if(percent && wallet) {
        global.donationsNiobio[wallet] = percent;
    }
}
